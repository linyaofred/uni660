    ...
    while (true)
    {
        ...
        if (packet_received_left)
        {
            ...
            data_buffer[0] =  ((data_payload_left[0] & 1<<8) ? 1:0) << 0 |
                              ...
                              ((data_payload_left[0] & 1<<3) ? 1:0) << 5 |
                              ((data_payload_left[0] & 1<<2) ? 1:0) << 6 |
            ...
            data_buffer[2] =  ((data_payload_left[1] & 1<<8) ? 1:0) << 0 |
                              ...
                              ((data_payload_left[1] & 1<<3) ? 1:0) << 5 |
                              ((data_payload_left[1] & 1<<2) ? 1:0) << 6 |
            ...
            data_buffer[4] =  ((data_payload_left[2] & 1<<8) ? 1:0) << 0 |
                              ...
                              ((data_payload_left[2] & 1<<3) ? 1:0) << 5 |
                              ((data_payload_left[2] & 1<<2) ? 1:0) << 6 |
            ...
            data_buffer[6] =  ((data_payload_left[3] & 1<<8) ? 1:0) << 0 |
                              ...
                              ((data_payload_left[3] & 1<<3) ? 1:0) << 5 |
                              ((data_payload_left[3] & 1<<2) ? 1:0) << 6 |
            ...
            data_buffer[8] =  ((data_payload_left[4] & 1<<8) ? 1:0) << 0 |
                              ...
                              ((data_payload_left[4] & 1<<3) ? 1:0) << 5 |
                              ((data_payload_left[4] & 1<<2) ? 1:0) << 6 |
                              ((data_payload_left[4] & 1<<1) ? 1:0) << 7;
